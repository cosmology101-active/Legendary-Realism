...
# Clear crafting grid using proper command structure
...
# Reinsert custom item
execute as @a[tag=crafting_player] if score @s temp_damage matches ..4 run give @s minecraft:gunpowder{components:{"minecraft:custom_data":{custom_model_data:1004},"minecraft:damage":{value:1}}}
