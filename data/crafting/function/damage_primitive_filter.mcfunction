...
# Slot 0: Check filter, increment damage, break if damage >= 5
...
execute as @a[tag=crafting_player] at @s if data entity @s Inventory[{Slot:0b,id:"minecraft:gunpowder",components:{"minecraft:custom_data":{custom_model_data:1004}}}] if score @s filter_damage matches 5.. run replaceitem entity @s container.0 air
...
execute as @a[tag=crafting_player] at @s if data entity @s Inventory[{Slot:1b,id:"minecraft:gunpowder",components:{"minecraft:custom_data":{custom_model_data:1004}}}] if score @s filter_damage matches 5.. run replaceitem entity @s container.1 air
...
execute as @a[tag=crafting_player] at @s if data entity @s Inventory[{Slot:2b,id:"minecraft:gunpowder",components:{"minecraft:custom_data":{custom_model_data:1004}}}] if score @s filter_damage matches 5.. run replaceitem entity @s container.2 air
...
execute as @a[tag=crafting_player] at @s if data entity @s Inventory[{Slot:3b,id:"minecraft:gunpowder",components:{"minecraft:custom_data":{custom_model_data:1004}}}] if score @s filter_damage matches 5.. run replaceitem entity @s container.3 air
...
execute as @a[tag=crafting_player] at @s if data entity @s Inventory[{Slot:4b,id:"minecraft:gunpowder",components:{"minecraft:custom_data":{custom_model_data:1004}}}] if score @s filter_damage matches 5.. run replaceitem entity @s container.4 air

# Slot 5 (corrected from "gunpaper" to "gunpowder")
...
execute as @a[tag=crafting_player] at @s if data entity @s Inventory[{Slot:5b,id:"minecraft:gunpowder",components:{"minecraft:custom_data":{custom_model_data:1004}}}] if score @s filter_damage matches 5.. run replaceitem entity @s container.5 air
...
execute as @a[tag=crafting_player] at @s if data entity @s Inventory[{Slot:6b,id:"minecraft:gunpowder",components:{"minecraft:custom_data":{custom_model_data:1004}}}] if score @s filter_damage matches 5.. run replaceitem entity @s container.6 air
...
execute as @a[tag=crafting_player] at @s if data entity @s Inventory[{Slot:7b,id:"minecraft:gunpowder",components:{"minecraft:custom_data":{custom_model_data:1004}}}] if score @s filter_damage matches 5.. run replaceitem entity @s container.7 air
...
execute as @a[tag=crafting_player] at @s if data entity @s Inventory[{Slot:8b,id:"minecraft:gunpowder",components:{"minecraft:custom_data":{custom_model_data:1004}}}] if score @s filter_damage matches 5.. run replaceitem entity @s container.8 air
